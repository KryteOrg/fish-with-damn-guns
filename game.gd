...
func _ready():
	...
	DiscordRPC.details = "fish is in game dnd"
	DiscordRPC.state = "In game, " + str(fish_left) + "/" + str(fish_max) + " fish left"
...
func _process(delta: float):
	...
	DiscordRPC.state = "In game, " + str(fish_left) + "/" + str(fish_max) + " fish left, Playing the level: Finland"
